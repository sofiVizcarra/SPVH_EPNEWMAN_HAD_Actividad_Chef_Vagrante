...
execute 'Finish Wordpress installation' do
  command 'sudo -u vagrant -i -- wp core install --path=/opt/wordpress/ --url=localhost --title="EPNEWMAN - Herramientas de automatización de despliegueS - SPVH Se logro mostrar las imagenes y pagina en español :)" --admin_user=admin --admin_password="Epnewman123" --admin_email=admin@epnewman.edu.pe'
